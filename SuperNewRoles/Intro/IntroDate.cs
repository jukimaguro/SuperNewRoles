...
namespace SuperNewRoles.Intro
{
    public class IntroDate
    {
        ...
        public static IntroDate HawkingJackalIntro = new IntroDate("HawkingJackal", RoleClass.HawkingJackal.color, 1, CustomRPC.RoleId.HawkingJackal);
        //イントロオブジェ
    }
}
